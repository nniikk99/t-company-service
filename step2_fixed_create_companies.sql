-- ШАГ 2 (ИСПРАВЛЕННЫЙ): Создаем записи только для существующих пользователей
...
-- Используем реальный user_id из результатов: 9522bbae-8aff-4a8b-9c1d-123456789abc
INSERT INTO user_companies (
    user_id,
    company_id,
    company_inn,
...
-- Используем реальный user_id из результатов: a1b2c3d4-e5f6-7890-abcd-ef1234567890
INSERT INTO user_companies (
    user_id,
    company_id,
    company_inn,
...
-- Используем реальный user_id из результатов: f1e2d3c4-b5a6-9870-fedc-ba0987654321
INSERT INTO user_companies (
    user_id,
    company_id,
    company_inn,
