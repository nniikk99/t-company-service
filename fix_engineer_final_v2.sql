...
-- Шаг 4: Проверяем структуру таблицы companies
SELECT column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'companies' 
ORDER BY ordinal_position;

-- Шаг 5: Создаем компанию Test company (без email, если колонки нет)
INSERT INTO companies (id, name, company_inn, address, phone, created_at, updated_at)
VALUES (
...
-- Шаг 6: Создаем нового инженера с уникальным телефоном
...
-- Шаг 7: Создаем запись в user_companies для инженера
