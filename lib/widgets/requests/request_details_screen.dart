  ...
  Widget _buildTimelineContent() {
    return Column(
      ...
      children: [
        ...
        _buildTimelineStep(
          title: (_currentRequest.completedAt != null || _currentRequest.status == RequestStatus.completed) ? 'Закрыта' : 'Закрытие',
          time: _currentRequest.completedAt,
          actor: (_currentRequest.completedAt != null || _currentRequest.status == RequestStatus.completed) ? 'Администратор' : null,
          icon: Icons.check_circle_outline,
          isCompleted: _currentRequest.completedAt != null || _currentRequest.status == RequestStatus.completed,
          color: const Color(0xFF2563EB),
          isLast: true,
        ),
      ],
