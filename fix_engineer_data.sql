...
-- Если инженер не найден или данные некорректны, создаем/обновляем
INSERT INTO user_profiles (
    ...
    '83c74ef6-497f-4640-957a-463cda010065', -- Используем существующий ID
    'Иван',
    'Инженеров',
    'engineer@test.com',
    '+7 (999) 123-45-67',
    ...
    true,
    true,
    '123456', -- Простой пароль для тестирования
    NOW(),
    NOW()
